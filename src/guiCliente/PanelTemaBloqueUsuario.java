...
public class PanelTemaBloqueUsuario extends JPanel {
	...
	public PanelTemaBloqueUsuario(Tema tema) {

		setPreferredSize(new Dimension(307, 25));
		setSize(315, 25);
		setLayout(null);
	...
	private String getCarpeta(){ //obtiene la carpeta si es C o Java
		PanelLenguajeCargaTemaUsuario panel =(PanelLenguajeCargaTemaUsuario)(this.getParent());
